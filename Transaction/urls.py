...
urlpatterns = [
    ...
    path('master_in', master_in_fun, name = 'master-in-data'),
    path('master_out',master_out_fun, name = 'master-out-data'),
    ...
    path('adddetail_in/<master_id>',adddetail_in, name='add-detail-in'),
